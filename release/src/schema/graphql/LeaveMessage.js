...
var LeaveMessageController_1 = require("../../controllers/LeaveMessageController");
...
var LeaveMsgPagesType = new graphql_1.GraphQLObjectType({
...
var query = {
        ...
        resolve: function (obj, args, ctx, info) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = args.id;
                        return [4 /*yield*/, LeaveMessageController_1.default.getById(id)];
                    case 1:
                        leaveMsg = _a.sent();
    ...
    leaveMsgs: {
        ...
        args: __assign({}, common_1.pageArgsFields, { description: {
                name: 'description',
                type: graphql_1.GraphQLString
            } }),
        resolve: function (obj, args, ctx, info) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, LeaveMessageController_1.default.pages(args)];
                    case 1:
                        pages = _a.sent();
