...
// comment pages type
var CommentPagesType = new graphql_1.GraphQLObjectType({
...
var query = {
        ...
        resolve: function (obj, args, ctx, info) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = args.id;
                        return [4 /*yield*/, CommentController_1.default.getById(id)];
                    case 1:
                        article = _a.sent();
    ...
    comments: {
        ...
        resolve: function (obj, args, ctx, info) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, CommentController_1.default.pages(args)];
                    case 1:
                        pages = _a.sent();
