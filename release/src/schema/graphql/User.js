...
// user pages type
var UserPagesType = new graphql_1.GraphQLObjectType({
    name: 'userPageType',
...
var query = {
        ...
        resolve: function (obj, args, ctx, info) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = args.id;
                        return [4 /*yield*/, UserController_1.default.getById(id)];
                    case 1:
                        article = _a.sent();
    ...
    users: {
        type: UserPagesType,
        args: __assign({}, common_1.pageArgsFields, { username: {
                type: graphql_1.GraphQLString
            }, nickName: {
                type: graphql_1.GraphQLString
            }, userType: {
        ...
        resolve: function (obj, args, ctx, info) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, UserController_1.default.pages(args)];
                    case 1:
                        pages = _a.sent();
...
var mutation = {
    user: {
        ...
        resolve: function (obj, args, ctx, info) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, UserController_1.default.insert(args, ctx)];
                    case 1:
                        result = _a.sent();
    ...
    editUser: {
        ...
        resolve: function (obj, args, ctx, info) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, UserController_1.default.update(args, ctx)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result];
                }
