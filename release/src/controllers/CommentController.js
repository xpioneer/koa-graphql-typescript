...
var comment_1 = require("../entities/mysql/comment");
var Moment = require("moment");
var CommentController = /** @class */ (function () {
    function CommentController() {
    }
    CommentController.getAll = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, typeorm_1.getManager().find(comment_1.Comment)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    CommentController.getById = function (id) {
        if (id === void 0) { id = ''; }
        return __awaiter(this, void 0, void 0, function () {
            var article;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, typeorm_1.getRepository(comment_1.Comment).findOne({ id: id })];
                    case 1:
                        article = _a.sent();
    ...
    CommentController.pages = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, typeorm_1.getRepository('comment').findAndCount(options)];
                    case 1:
                        pages = _a.sent();
