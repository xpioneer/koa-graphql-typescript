...
var tag_1 = require("../entities/mysql/tag");
...
var TagController = /** @class */ (function () {
    ...
    TagController.getAll = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log(args);
                        return [4 /*yield*/, typeorm_1.getManager().find(tag_1.Tag)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    TagController.getById = function (id) {
        if (id === void 0) { id = ''; }
        return __awaiter(this, void 0, void 0, function () {
            var tag;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, typeorm_1.getRepository(tag_1.Tag).findOne({ id: id })];
                    case 1:
                        tag = _a.sent();
                        return [2 /*return*/, tag];
                }
    ...
    TagController.pages = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, typeorm_1.getRepository(tag_1.Tag).findAndCount(options)];
                    case 1:
                        pages = _a.sent();
    ...
    TagController.insert = function (args, ctx) {
        return __awaiter(this, void 0, void 0, function () {
            var model, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, typeorm_1.getRepository(tag_1.Tag).save(model)];
                    case 1:
                        result = _a.sent();
    ...
    TagController.update = function (args, ctx) {
        return __awaiter(this, void 0, void 0, function () {
            var model, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
